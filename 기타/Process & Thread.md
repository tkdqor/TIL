...
- https://www.youtube.com/watch?v=iks_Xb9DtTM&list=LL&index=9&t=4s 해당 영상처럼 스레드를 사용하는 코드들을 살펴보고 짜보면서 이해하고 나면, 오늘날 사용되는 동시성 프로그래밍을  
  보다 더 잘 활용할 수 있도록 하는 기초지식이 된다. 
